...
import { Article1 } from '@src/containers/layouts/articles/article1/article1.component';

/* tslint:disable */
       
/*var posts = fetch('https://dev.smartmoneygains.com/wp-json/wp/v2/posts?_embed')
  ...
  this.http.request('https://dev.smartmoneygains.com/wp-json/wp/v2/posts?_embed')
    ...
    export const articles: Article[] = Array.of(this.data);*/
