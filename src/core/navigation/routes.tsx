...
//import { NewsScreen } from 'src/containers/layouts/screens/NewsScreen';
...
const SettingsNavigator: NavigationContainer = createStackNavigator(
  {
    ['Settings']: ThemesContainer,
  }, {
    defaultNavigationOptions: MenuNavigationOptions,
  },
);

const MarketsNavigator: NavigationContainer = createStackNavigator(
  {
    ['Markets']: ComponentsContainer,
...
const MenuNavigator = createBottomTabNavigator({
  ['News']: NewsNavigator,
  ['Markets']: MarketsNavigator,
  ['Themes']: ArticlesContainer,
