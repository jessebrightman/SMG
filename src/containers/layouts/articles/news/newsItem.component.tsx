...
export type NewsItemProps = ThemedComponentProps & ComponentProps;

class NewsItemComponent extends React.Component<NewsItemProps> {
...
export const NewsItem = withStyles(NewsItemComponent, (theme: ThemeType) => ({
  container: {
    borderRadius: 12,
    overflow: 'hidden',
  },
